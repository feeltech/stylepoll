...
export interface WardrobePreviewItems {
  index: number;
  wardrobe:WardRobe
}
const WardrobePreviewItem = ({
  index,wardrobe
  ...
  const _onShowStory = (wardrobe:WardRobe) => {
    navigate("wardrobe_view",{tagName:wardrobe.tagName,posts:wardrobe.posts})
    // if (seen) {
...
export default React.memo(WardrobePreviewItem);
