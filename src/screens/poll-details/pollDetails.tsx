                ...
                >
                    ...
                    />
                        <View style={{marginTop: 20}}>
                            ...
                            <TouchableOpacity onPress={()=>{navigate("poll_stats",{poll:this.state.poll})}}>
                                <View style={[{flexDirection: "row", margin: 5}]}>
                                    ...
                                    <View style={{flexDirection:'column',justifyContent:'center'}}>
                                        <Progress.Bar progress={0.8} width={SCREEN_WIDTH - 50} color={'#82CA5B'} height={20} borderRadius={10}/>
                                    </View>
                                </View>
                                <View style={[{flexDirection: "row", margin: 5}]}>
                                    <View style={{flexDirection:'column',justifyContent:'center'}}>
                                    ...
                                    <View style={{flexDirection:'column',justifyContent:'center'}}>
                                        ...
                                        <Progress.Bar progress={0.3} width={SCREEN_WIDTH - 50} color={'#F7734D'} height={20}
                                                      borderRadius={10}/>
                                    </View>
                            ...
                            <View style={[{flexDirection: "row", margin: 5}]}>
                                ...
                                <View style={{flexDirection:'column',justifyContent:'center'}}>
                                    <Text style={{color: "#000", fontWeight: "bold", marginRight: 5}}>{this.state.timeRemaining}</Text>
                                </View>
                                <View style={{flexDirection:'column',justifyContent:'center'}}>
                                    <Progress.Bar progress={0.3} width={SCREEN_WIDTH - 80} color={'#979797'} height={20}
                                                  borderRadius={10}/>
                                </View>
                            </View>
                        </View>
