                        ...
                        <View style={styles.graph_container}>
                            ...
                            <View style={{flexDirection:'row',marginBottom:20,marginTop:10,alignItems:'center'}}>
                                <View style={{width:30, height:200,margin:20}}>
                                    <View style={{backgroundColor:'red',marginTop:110,height:90}}></View>
                                    <Text style={{fontWeight:"bold"}}>30%</Text>
                                    <View style={{height:35,width:35, borderRadius:35/2,backgroundColor:"#FFF",borderColor:'red',borderWidth:1,justifyContent:'center',alignItems:'center'}}>
                                        <Image
                                ...
                                <View style={{width:30, height:200,margin:20}}>
                                    <View style={{backgroundColor:'green',marginTop:30,height:170}}></View>
                                    <Text style={{fontWeight:"bold"}}>70%</Text>
                                    <View style={{height:35,width:35, borderRadius:35/2,backgroundColor:"#FFF",borderColor:'green',borderWidth:1,justifyContent:'center',alignItems:'center'}}>
                                        <Image
