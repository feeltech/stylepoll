...
import {reactToPoll} from "../../services/firebase/firebaseService";
...
export default class StoryView extends React.Component<any, IStoryViewStates>{
    ...
    private onLikePoll = () => {
        const poll:AlertPoll = this.state.poll
        poll.likes.push(this.state.user)
        reactToPoll(this.state.user,poll).then(res => {
        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                <ImageBackground source={{uri:this.state.poll.image}} style={styles.image}>
                    <View style={{flex:10}}/>
                    <View style={{flex:1, flexDirection:'row',justifyContent:'space-between',marginLeft:30,marginRight:30}}>
                            <TouchableOpacity style={{height:35,width:35, borderRadius:35/2,backgroundColor:"#FFF",justifyContent:'center',alignItems:'center'}} onPress={this.onDislikePoll}>
                                <Image
                            ...
                            <TouchableOpacity style={{height:35,width:35, borderRadius:35/2,backgroundColor:"#FFF",justifyContent:'center',alignItems:'center'}} onPress={this.onLikePoll}>
                                <Image
