    ...
    render() {
        ...
        return (
            <SafeAreaView style={styles.container}>
                    ...
                    />
                <ImageBackground source={{uri:'https://i.pinimg.com/736x/cd/83/f5/cd83f51c1cf0dc3f1e9f632640fed7b7.jpg'}} style={styles.image}>
                    <View style={{flex:10}}/>
                    <View style={{flex:1, flexDirection:'row',justifyContent:'space-between',marginLeft:30,marginRight:30}}>
                            <TouchableOpacity style={{height:35,width:35, borderRadius:35/2,backgroundColor:"#FFF",justifyContent:'center',alignItems:'center'}}>
                                <Image
